...
export const COST_DATA: Record<string, CountryData> = {
  us: {
    ...
    degrees: {
      bachelor: { publicTuition: 35000, privateTuition: 65000, defaultDuration: 4 },
      master_taught: { publicTuition: 40000, privateTuition: 68000, defaultDuration: 1.5 },
  ...
  uk: {
    ...
    degrees: {
      bachelor: { publicTuition: 28000, privateTuition: 28000, defaultDuration: 3 },
      master_taught: { publicTuition: 32000, privateTuition: 32000, defaultDuration: 1 },
  ...
  hk: {
    ...
    degrees: {
      bachelor: { publicTuition: 170000, privateTuition: 160000, defaultDuration: 4 },
  ...
  sg: {
    ...
    degrees: {
      ...
      master_taught: { publicTuition: 45000, privateTuition: 45000, defaultDuration: 1 },
