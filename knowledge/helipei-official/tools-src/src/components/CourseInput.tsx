        ...
        <div className="flex gap-2">
          <button 
            onClick={() => {
              fillExample();
              if (window.gtag) {
                window.gtag('event', 'fill_example_courses', {
            ...
            <div className="col-span-3">
              ...
              <div className="relative">
                <input 
                  ...
                  className={`w-full px-3 py-2 bg-white border rounded-lg focus:outline-none focus:ring-2 focus:border-transparent transition-shadow text-neutral-900 text-sm
                    ${course.score > 100 || course.score < 0 
